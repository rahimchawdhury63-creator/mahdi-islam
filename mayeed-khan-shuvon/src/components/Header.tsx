...
export function Header({ currentPath }: { currentPath: string }) {
  ...
  return (
    <>
      ...
      {/*
        Sticky group: the utility bar scrolls away, the navigation does not.
        The sticky element's containing block has to be the full page, which is
        why it deliberately is not nested inside a header-sized wrapper — a
        sticky child would otherwise stop sticking as soon as that wrapper
        scrolled past.
      */}
